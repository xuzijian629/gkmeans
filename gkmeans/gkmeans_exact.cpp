...
#include "lloyd_warshall_floyd.hpp"
...
int main() {
    ...
    vector<vector<double>> dist = warshall_floyd(g);
    cerr << "finish warshall floyd" << endl;
    ...
    vector<int> predicted_labels = lloyd_warshall_floyd(g, dist, centers);
